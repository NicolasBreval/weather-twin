package org.nbreval.weather_twin.gateway.computing.domain;

import java.io.Serializable;
import java.util.function.Function;

/**
 * Custom class used to represent a tuple of three elements. It's an immutable object, so none attribute can be modified after the object creation.
 */
public class Triple<L extends Serializable, M extends Serializable, R extends Serializable> implements Serializable {
    ...
    /**
     * Creates a new Triple object based on another one, modifying each element of it using a mapping function
     ...
     * @return
     */
    public static <L extends Serializable, M extends Serializable, R extends Serializable> Triple<L, M, R> of(L left, M middle, R right) {
