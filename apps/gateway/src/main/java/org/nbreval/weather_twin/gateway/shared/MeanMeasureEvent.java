...
/**
 * Event representing the mean measure over a specified time window from a sensor.
 */
public class MeanMeasureEvent extends SensorNotification {
    /**
     * Size of the time window (in milliseconds) over which the mean measure is calculated.
     */
