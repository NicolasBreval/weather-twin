package org.nbreval.weather_twin.gateway.entrypoint.adapter.in.config;
...
/**
 * Configuration properties for the embedded MQTT broker used by {@link MqttSensorListenerAdapter}.
 * 
 * Properties are prefixed with `entrypoint.listener.mqtt` and include:
 * <ul>
 *   <li>port: the port on which the MQTT broker will listen for incoming connections (default: 1883)</li>
 *   <li>persistence.enabled: whether to enable message persistence (default: true)</li>
 *   <li>persistence.path: the file system path where the MQTT broker will store its persistent data; if null or blank, persistence is disabled (default: empty)</li>
 * </ul>
 */
@Component
...
public class MqttBrokerProperties {
    ...
    /**
     * Converts the current properties to a {@link Properties} object suitable for configuring the MQTT broker.
    ...
    public static class Persistence {
        ...
        /**
         * Gets the file system path where the MQTT broker will store its persistent data.
        ...
        /**
         * Sets the file system path where the MQTT broker will store its persistent data.
